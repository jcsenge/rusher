...
import 'package:rusher/components/hills.dart';
...
class Rusher extends FlameGame with HasCollidables, KeyboardEvents {
  final Player _player = Player();
  final World _world = World();
  final Hills _hills = Hills();
  ...
  void addWorldCollision() async =>
      (await MapLoader.readRusherCollisionMap()).forEach((rect) {
        add(WorldCollidable()
